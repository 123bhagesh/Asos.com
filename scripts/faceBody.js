...
{"name":"Mane 'n Tail Herbal Gro Leave-In Creme","price":"10","color":"No colour","image":"https://images.asos-media.com/products/mane-n-tail-herbal-gro-leave-in-creme/23137549-1-nocolour?$n_480w$&wid=476&fit=constrain"},{"name":"L'Oreal Men Expert Hypoallergenic Deodorant, Magnesium Defence Hypoallergenic 48 Hour Protection Mens Deodorant","price":"5","color":"No Colour","image":"https://images.asos-media.com/products/loreal-men-expert-hypoallergenic-deodorant-magnesium-defence-hypoallergenic-48-hour-protection-mens-deodorant/202533082-1-nocolour?$n_480w$&wid=476&fit=constrain"},
{"name":"391 e.l.f. Flawless Satin Foundation","price":"10","color":"No Colour","image":"https://images.asos-media.com/products/elf-flawless-satin-foundation/202524037-1-natural?$n_480w$&wid=476&fit=constrain"},{"name":"& Other Stories hand cream in neon rush","price":"5","color":"Neon rush","image":"https://images.asos-media.com/products/other-stories-hand-cream-in-neon-rush/202658838-1-neonrush?$n_480w$&wid=476&fit=constrain"},
{"name":"Missguided Babe Power Eau De Parfum 10ml","price":"11","color":"No Colour","image":"https://images.asos-media.com/products/missguided-babe-power-eau-de-parfum-10ml/202780294-1-nocolour?$n_480w$&wid=476&fit=constrain"},{"name":"This Works Sleep Spa Set","price":"21","color":"No Colour","image":"https://images.asos-media.com/products/this-works-sleep-spa-set/202780151-1-nocolour?$n_480w$&wid=476&fit=constrain"},
{"name":"100 The Ritual of Jing Conditioner 250ml","price":"14","color":"No Colour","image":"https://images.asos-media.com/products/the-ritual-of-jing-conditioner-250ml/202885245-1-nocolour?$n_480w$&wid=476&fit=constrain"},{"name":"NEOM Sleep Heroes Set","price":"42","color":"No Colour","image":"https://images.asos-media.com/products/neom-sleep-heroes-set/202780331-1-nocolour?$n_480w$&wid=476&fit=constrain"},
{"name":"144 Elie Saab Girl of Now Lovely Eau De Parfum 50ml","price":"68","color":"No Colour","image":"https://images.asos-media.com/products/elie-saab-girl-of-now-lovely-eau-de-parfum-50ml/202536703-1-nocolour?$n_480w$&wid=476&fit=constrain"},{"name":"Issey Miyake Nectar D'Issey Eau de Parfum 30ml","price":"47","color":"No Colour","image":"https://images.asos-media.com/products/issey-miyake-nectar-dissey-eau-de-parfum-30ml/202440979-1-nocolour?$n_480w$&wid=476&fit=constrain"},
...
{"name":"130 I Heart Revolution x Disney Fairytale Jelly Eye Shimmer - Heihei","price":"7","color":"Heihei","image":"https://images.asos-media.com/products/i-heart-revolution-x-disney-fairytale-jelly-eye-shimmer-heihei/202781479-1-heihei?$n_480w$&wid=476&fit=constrain"},{"name":"Revolution Hot Shot Kombucha Kiss Primer","price":"9","color":"No Colour","image":"https://images.asos-media.com/products/revolution-hot-shot-kombucha-kiss-primer/202718457-1-nocolour?$n_480w$&wid=476&fit=constrain"},
...
function appendProduct(face_body) {
  hairDiv.innerHTML = null;
  face_body.forEach(function (elem) {
...
appendProduct(face_body);

document.querySelector("#sorter").addEventListener("click", sortByPrice);
function sortByPrice() {
    face_body.map(function (elem) {
        var sorting = document.querySelector("#sorter").value;
        console.log(sorting);
        if (sorting == "l2h") {
            face_body.sort(function (a, b) { return a.price - b.price })
            appendProduct(face_body)
        }
        else if (sorting == "h2l") {
            face_body.sort(function (a, b) { return b.price - a.price })
            appendProduct(face_body)
        }
            ...
            var s = face_body.sort(SortArray)
            appendProduct(s)
        }
        else if (sorting == "z2a") {
            function SortArray(x, y) {
            ...
            var sort = face_body.sort(SortArray)
            appendProduct(sort)
        }
    })
}
